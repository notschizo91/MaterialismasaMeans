...
/// Wire keyring dragging: getRing () -> {X; Y; R} or null, onMove p (p.x/p.y mm).
[<Import("setRingDrag", "./viewer.js")>]
let setRingDrag (viewer: obj) (getRing: unit -> obj) (onMove: obj -> unit) : unit = jsNative
